...
/**
 * Allows for the instantiation of third grade quizzes.
 * @author William Pruitt
 */
public class ThirdGradeTestSelector extends javax.swing.JFrame {

    /**
     * Creates new form TestSelecter
     */
    public ThirdGradeTestSelector() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("Third Grade Quiz Menu");
...
// TODO add your handling code here:
    ...
    private void select2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select2ActionPerformed
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            ...
            dispose();
            ThirdGradeQuizWindow test = new ThirdGradeQuizWindow();
    ...
    private void select1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select1ActionPerformed
        ...
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            ...
            dispose();
            ThirdGradePracticeQuiz test = new ThirdGradePracticeQuiz();
            test.setVisible(true);
            test.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThirdGradeTestSelector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThirdGradeTestSelector tgt = new ThirdGradeTestSelector();
                tgt.setVisible(true);
