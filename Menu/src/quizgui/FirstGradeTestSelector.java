...
/**
 *Allows for the instantiation of first grade quizzes.
 * @author William Pruitt
 */
public class FirstGradeTestSelector extends javax.swing.JFrame {

    /**
     * Creates new form TestSelecter
     */
    public FirstGradeTestSelector() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Addition Quiz", "Comparison Quiz" }));
        ...
        label1.setText("First Grade Quiz Menu");
...
// TODO add your handling code here:
    ...
    private void select2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select2ActionPerformed
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            dispose();
            FirstGradeQuizWindow test = new FirstGradeQuizWindow();
            test.setVisible(true);
            test.setLocationRelativeTo(null);

            test.addQuiz(Student.currentStudent); //creates a quiz for whoever is set as currentStudent.

        } else if (jComboBox1.getSelectedItem().equals("Comparison Quiz")) {
            ...
            test.comparableQuiz(Student.currentStudent); //creates a quiz for whoever is set as currentStudent.

        }
    }//GEN-LAST:event_select2ActionPerformed
/**
     * Creates a subtraction or comparison based first-grade quiz.
    ...
    private void select1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select1ActionPerformed
        ...
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            ...
            dispose();
            FirstGradePracticeQuiz test = new FirstGradePracticeQuiz();
            test.setVisible(true);
            test.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FirstGradeTestSelector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FirstGradeTestSelector fgt = new FirstGradeTestSelector();
                fgt.setVisible(true);
