...
/**
 *Makes first grade level practice quizzes.
 * @author William Pruitt
 */
public class FirstGradePracticeQuiz extends javax.swing.JFrame {

    /**
     * Creates new form PracticeTest
     */
    public FirstGradePracticeQuiz() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("First Grade Practice Test");
    ...
    public void comparableQuiz(Student student) {
        ...
        newQuiz.generateGreaterThanQuestion();     //Adds a "greater than" question in even spots and "less than" questions in odd spots.
        ...
        answers[9] = FirstGradeQuiz.answer;           //Finished adding questions.
        ...
        label2.setText("Which number is bigger?"); //The first question is a "greater than" question.
        nextButtonEnabled = true;      //Lets the user click the "Next" button;

        comparableQuiz = true;        //Lets the class know that this is a comparison quiz.
