...
/**
 * Fifth grade quiz for a grade.
 * @author William Pruitt
 */
public class FifthGradeQuizWindow extends javax.swing.JFrame {

    /**
     * Creates new form PracticeTest
     */
    public FifthGradeQuizWindow() {
        initComponents();
    }
    ...
    private void nextQuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextQuestionActionPerformed
        ...
        if (answerChecked && nextButtonEnabled && index <= 9) {
            FifthGradeQuizWindow pt = new FifthGradeQuizWindow();
    ...
    /**
     * Creates a addition based fifth-grade quiz.
     * @param student The student currently logged in.
     */
    ...
    /**
     * Creates a multiplication based fifth-grade quiz.
     * @param student The student currently logged in.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FifthGradeQuizWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
