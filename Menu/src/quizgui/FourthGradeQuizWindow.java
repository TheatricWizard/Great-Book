...
/**
 * Fourth grade quiz for a grade.
 * @author William Pruitt
 */
public class FourthGradeQuizWindow extends javax.swing.JFrame {

    /**
     * Creates new form PracticeTest
     */
    public FourthGradeQuizWindow() {
        initComponents();
    }
    ...
    private void nextQuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextQuestionActionPerformed
        ...
        if (answerChecked && nextButtonEnabled && index <= 9) {
            FourthGradeQuizWindow pt = new FourthGradeQuizWindow();
...
/**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FourthGradeQuizWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
