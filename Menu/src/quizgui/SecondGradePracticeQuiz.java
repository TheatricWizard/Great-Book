...
import quizzes.SecondGradeQuiz;
import users.Student;

/**
 *Makes second grade level practice quizzes.
 * @author William Pruitt
 */
public class SecondGradePracticeQuiz extends javax.swing.JFrame {

    /**
     * Creates new form PracticeTest
     */
    public SecondGradePracticeQuiz() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Second Grade Practice Test");
    ...
    private void nextQuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextQuestionActionPerformed
        ...
        if (answerChecked && nextButtonEnabled && index <= 9) {
            SecondGradePracticeQuiz pt = new SecondGradePracticeQuiz();
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        ...
        dispose();
        SecondGradeTestSelector sgl = new SecondGradeTestSelector();
        sgl.setVisible(true);
        sgl.setLocationRelativeTo(null);
...
/**
     * Creates a subtraction based second-grade quiz.
    ...
    public void subQuiz(Student student) {
        ...
        index = 0;
        correctAnswers = 0;
        SecondGradeQuiz newQuiz = new SecondGradeQuiz(student);

        for (int i = 0; i < 10; i++) {
            newQuiz.generateSubQuestion();
            questions[i] = SecondGradeQuiz.question;
            answers[i] = SecondGradeQuiz.answer;
        }
...
/**
     * Creates a addition based second-grade quiz.
     * @param student The student currently logged in.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecondGradePracticeQuiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
