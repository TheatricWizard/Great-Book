...
/**
 * Third grade quiz for a grade.
 * @author William Pruitt
 */
public class ThirdGradeQuizWindow extends javax.swing.JFrame {

    /**
     * Creates new form PracticeTest
     */
    public ThirdGradeQuizWindow() {
        initComponents();
    }
    ...
    private void nextQuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextQuestionActionPerformed
        ...
        if (answerChecked && nextButtonEnabled && index <= 9) {
            ThirdGradeQuizWindow pt = new ThirdGradeQuizWindow();
...
/**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThirdGradeQuizWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
