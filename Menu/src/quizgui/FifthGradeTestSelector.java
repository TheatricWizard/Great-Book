...
/**
 * Allows for the instantiation of fifth grade quizzes.
 * @author William Pruitt
 */
public class FifthGradeTestSelector extends javax.swing.JFrame {

    /**
     * Creates new form TestSelecter
     */
    public FifthGradeTestSelector() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Addition Quiz", "Subtraction Quiz", "Multiplication Quiz" }));
        ...
        label1.setText("Fifth Grade Quiz Menu");
    ...
    private void select2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select2ActionPerformed
        ...
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            dispose();
            FifthGradeQuizWindow test = new FifthGradeQuizWindow();
    ...
    private void select1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select1ActionPerformed
        ...
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            ...
            dispose();
            FifthGradePracticeQuiz test = new FifthGradePracticeQuiz();
            test.setVisible(true);
            test.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FifthGradeTestSelector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FifthGradeTestSelector fgt = new FifthGradeTestSelector();
                fgt.setVisible(true);
