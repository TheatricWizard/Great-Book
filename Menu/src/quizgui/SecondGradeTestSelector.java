...
/**
 *Allows for the instantiation of second grade quizzes.
 * @author William Pruitt
 */
public class SecondGradeTestSelector extends javax.swing.JFrame {

    /**
     * Creates new form TestSelecter
     */
    public SecondGradeTestSelector() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Addition Quiz", "Subtraction Quiz" }));
        ...
        label1.setText("Second Grade Quiz Menu");
...
// TODO add your handling code here:
    ...
    private void select2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select2ActionPerformed
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            ...
            dispose();
            SecondGradeQuizWindow test = new SecondGradeQuizWindow();
    ...
    private void select1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select1ActionPerformed
        ...
        if (jComboBox1.getSelectedItem().equals("Addition Quiz")) {
            ...
            dispose();
            SecondGradePracticeQuiz test = new SecondGradePracticeQuiz();
            test.setVisible(true);
            test.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecondGradeTestSelector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SecondGradeTestSelector sgc = new SecondGradeTestSelector();
                sgc.setVisible(true);
                sgc.setLocationRelativeTo(null);
